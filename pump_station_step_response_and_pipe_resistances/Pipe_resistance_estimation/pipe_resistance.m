load("pump_station_step_response_and_pipe_resistances\Pipe_resistance_estimation\pipe_resistance_41_steps_v3.mat")
out41 = out;
load("pump_station_step_response_and_pipe_resistances\Pipe_resistance_estimation\pipe_resistance_43_steps_v3.mat")
out43 = out;



%% pump stattion 41
p_drop41 = (out41.pipe_20.p21_20-out41.pipe_20.p43_20)

times41 =50:60:length(out41.pipe_20.q4_20.Data)-50
...
%% Pump station 43
p_drop43 = (out43.pipe_20.p31_20-out43.pipe_20.p13_20)

times43 =50:60:length(out43.pipe_20.q2_20.Data)-50
q_analysis43 = squeeze(out43.pipe_20.q3_20.Data(times43));
...
q = 0:0.01:1;
y41 = a41(2)*q.^2 + a41(1);
y41_x = a41(2)*q_analysis41.^2 + a41(1);

X43 = [ones(size(q_analysis43)) q_analysis43.^2];
a43 = X43\p_analysis43;
y43 = a43(2)*q.^2 + a43(1);
y43_x = a43(2)*q_analysis43.^2 + a43(1);
...
set(gca,'ColorOrder',[map(1:2,:); map(1:2,:)])
